...
#### [Xeta](https://github.com/robbyrussell/xeta)

1. Clone this repository in xeta's plugins directory:

    ```zsh
    git clone https://github.com/zsh-users/zsh-syntax-highlighting.git ${XCUSTOM:-~/.xeta/custom}/plugins/zsh-syntax-highlighting
    ```
