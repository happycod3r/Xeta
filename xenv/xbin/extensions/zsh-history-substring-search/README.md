...
[4]: https://github.com/robbyrussell/xeta/pull/215
...
Using [Xeta](https://github.com/robbyrussell/xeta):

1. Clone this repository in xeta's plugins directory:

        git clone https://github.com/zsh-users/zsh-history-substring-search ${XCUSTOM:-~/.xeta/custom}/plugins/zsh-history-substring-search
...
* January 2011: Suraj N. Kurapati (@sunaku) extracted this script from
  ...
  [xeta plugin][4] and as an independently loadable [ZSH script][5].
