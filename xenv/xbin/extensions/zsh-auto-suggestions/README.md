...
**Note:** If you are using Xeta, you can put this configuration in a file in the `$XCUSTOM` directory. See their comments on [overriding internals](https://github.com/robbyrussell/xeta/wiki/Customization#overriding-internals).
